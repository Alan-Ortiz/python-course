# lista1= ["jamón","huevito", "5", "catsup", "#café", "agua"]
# numeros= [0,1,2,3,4,5]
# #lista1[1]="huevo"
# #print(lista1)
...
#     print(lista1[elemento],elemento)
...
# listaRon= ["pan", "salchicha", "mayonesa", "katsup", 2, 3]
# # print(len(listaRon))
# # print(range(len(listaRon)))
# # for e in listaRon:
# #     print (e)
# cadena= ("pastel, café, té")
# for c in cadena:
#     print(c)
